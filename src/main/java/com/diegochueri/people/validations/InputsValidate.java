...
public class InputsValidate {
	...
	public void validateIfPersonUpdateInputIsNull(PersonUpdateDto personInfoToUpdate) {
		if (personInfoToUpdate.getName() == null && personInfoToUpdate.getBirthDate() == null) {
			throw new UpdateDataNotInformedException();
		}
	}

	public void validateIfAddressUpdateInputIsNull(AddressUpdateDto addressInfoToUpdate) {
